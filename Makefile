...
CFILES=crypto_core_driver.c callbacks.c json_response_utils.c commands/set_flags.c commands/sign_transaction.c commands/do_pow.c commands/generate_address.c commands/generate_random_seed.c commands/attach_to_tangle.c commands/test_hardware_acceleration.c
OFILES=crypto_core_driver.o callbacks.o json_response_utils.o set_flags.o sign_transaction.o do_pow.o generate_address.o generate_random_seed.o attach_to_tangle.o test_hardware_acceleration.o
...
crypto_core_driver.o: src/crypto_core_driver.c
	mkdir -p $(BUILD_DIR)
	cd $(BUILD_DIR) && $(CC) -I../. $(CFLAGS) $(foreach file,$(CFILES),../$(file)) -DDEBUG -g -O0
